...
class Invoice
{
     ...
     * @Groups({"invoices_read", "customers_read", "invoices_subresource"})
     * @Assert\DateTime(message="La date de la facture doit être au format YYYY-MM-DD")
     ...
     * @Assert\Choice(choices={"SENT", "PAID", "CANCELLED"}, message="Le status doit être soit 'SENT', 'PAID', 'CANCELLED'")
     */
    private $status;
    ...
    /**
     * Permet de récupérer l'émetteur de la facture
     * 
